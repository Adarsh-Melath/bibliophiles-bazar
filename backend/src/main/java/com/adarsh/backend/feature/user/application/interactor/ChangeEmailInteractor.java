...
public class ChangeEmailInteractor implements ChangeEmailUseCase {
    private static final Logger logger = LoggerFactory.getLogger(ChangeEmailInteractor.class);
    private final UserCommandRepository userCommandRepository;
    private final UserQueryRepository userQueryRepository;

    @Override
    public void execute(String email, ChangeEmailCommand command) {
        logger.info(UserInteractorLogConstants.CHANGE_EMAIL_REQUEST, email);
        ...
        logger.info(UserInteractorLogConstants.CHANGE_EMAIL_SUCCESS, command.email());
    }
}
