    ...
    void testAddressUpdate() {
        ...
        if (!entities.isEmpty()) {
            ...
            if (opt.isPresent()) {
                ...
                address.updateAddress(address.getFullName(), address.getPhone(), address.getAddressLine(), address.getCity(), address.getState(), address.getPincode(), address.getAddressLine2(), address.getCountry(), newType, newDefault);
